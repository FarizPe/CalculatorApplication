...
public class CalculatorScientificActivity extends AppCompatActivity {
    ...
    Button dashboard, clearbutton, dividebutton, multiplybutton, deletebutton, button7, button8, button9, minusbutton, button4,
        ...
        stpower2nd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    ...
                    Toast t = Toast.makeText(CalculatorScientificActivity.this, "Syntax ERROR", Toast.LENGTH_LONG);
...
//                 txtbtn.setText(Math.PI + " ");
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent abt = new Intent(CalculatorScientificActivity.this, MainActivity.class);
                startActivity(abt);
            }
        });
    }
